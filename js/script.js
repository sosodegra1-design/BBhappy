...
const TRANSLATIONS = {
  fr: {
    ...
    'marques.hero.desc': 'BBVOLTEX sélectionne pour vous des marques engagées, exigeantes sur la qualité, la sécurité et la fiabilité de leurs produits.',
    ...
    'brand2.desc': 'Vêtements 100% coton biologique certifié GOTS, doux et confortables pour toute la famille.',
    'brand2.cta': 'Voir les vêtements coton bio →',
    'brand3.desc': 'Chaussures souples et respirantes, conçues pour accompagner chaque étape du quotidien avec style.',
  ...
  en: {
    ...
    'marques.hero.desc': 'BBVOLTEX selects committed brands for you, focused on product quality, safety and reliability.',
    ...
    'brand2.desc': '100% GOTS-certified organic cotton clothing, soft and comfortable for the whole family.',
    'brand2.cta': 'See organic cotton clothing →',
    'brand3.desc': 'Soft, breathable shoes designed to support every step of everyday life in style.',
