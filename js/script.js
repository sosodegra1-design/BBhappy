...
const TRANSLATIONS = {
  fr: {
    'topbar.text': '🚚 Livraison standard gratuite en France &nbsp;•&nbsp; ✨ -20% sur les soldes avec le code SOLEIL',
    ...
    'shipping.standard.title': 'Standard', 'shipping.standard.desc': '3 à 5 jours ouvrés — Gratuite en France',
  ...
  en: {
    'topbar.text': '🚚 Free standard delivery in France &nbsp;•&nbsp; ✨ -20% on sale items with code SOLEIL',
    ...
    'shipping.standard.title': 'Standard', 'shipping.standard.desc': '3 to 5 business days — Free in France',
