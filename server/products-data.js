...
const ICONS = {
  ...
  collier: `<svg viewBox="0 0 100 100"><path d="M30 16c0 12 8 20 20 20s20-8 20-20" fill="none" stroke="#fff" stroke-width="6" stroke-linecap="round"/><path d="M50 36v18" stroke="#fff" stroke-width="5"/><path d="M50 54l11 15-11 11-11-11z" fill="#fff"/></svg>`,
  bracelet: `<svg viewBox="0 0 100 100"><circle cx="50" cy="52" r="34" fill="none" stroke="#fff" stroke-width="10"/><circle cx="50" cy="16" r="6" fill="#fff"/></svg>`,
  bague: `<svg viewBox="0 0 100 100"><circle cx="50" cy="60" r="28" fill="none" stroke="#fff" stroke-width="9"/><path d="M36 30 50 12 64 30 50 40Z" fill="#fff"/></svg>`,
  ceinture: `<svg viewBox="0 0 100 100"><rect x="6" y="44" width="88" height="14" rx="4" fill="#fff" opacity=".85"/><rect x="38" y="34" width="24" height="34" rx="4" fill="#fff"/><circle cx="50" cy="51" r="4" fill="#4a4358" opacity=".3"/></svg>`,
  sacamain: `<svg viewBox="0 0 100 100"><path d="M28 42a22 14 0 0 1 44 0" fill="none" stroke="#fff" stroke-width="6"/><path d="M20 42h60l6 44a6 6 0 0 1-6 6H20a6 6 0 0 1-6-6z" fill="#fff"/><rect x="42" y="52" width="16" height="10" rx="2" fill="#4a4358" opacity=".2"/></svg>`,
  sacados: `<svg viewBox="0 0 100 100"><path d="M28 30a22 16 0 0 1 44 0v6H28z" fill="#fff" opacity=".8"/><rect x="20" y="36" width="60" height="52" rx="14" fill="#fff"/><rect x="38" y="48" width="24" height="16" rx="4" fill="#4a4358" opacity=".2"/><path d="M32 36v-8M68 36v-8" stroke="#fff" stroke-width="6" stroke-linecap="round"/></svg>`
};
...
const PRODUCTS = [
  ...
  /* ===== BIJOUX & ACCESSOIRES ===== */
  {
    ...
    description: '✨ Le Collier Cœur &amp; Pierres de Naissance : l\'élégance qui raconte votre histoire. Plus qu\'un simple bijou, un véritable symbole d\'amour et de famille.\n\nOffrez ou offrez-vous ce magnifique collier personnalisable en plaqué or rose 18 carats, conçu pour capturer les moments les plus précieux de votre vie. Au centre, un élégant pendentif en forme de cœur veille sur un écrin de charms étincelants sertis de cristaux façon diamant.\n\n💎 Ce qui rend ce bijou unique :<br>• Votre histoire en un regard : personnalisez-le avec jusqu\'à 12 pierres de naissance pour représenter les êtres qui vous sont chers (famille, enfants, couple).<br>• Brillance et durabilité : fabriqué en cuivre de haute qualité avec un somptueux plaquage or rose 18 carats, il résiste à la vie de tous les jours tout en gardant son éclat magique.<br>• Confort absolu : une chaîne croisée délicate de 45 cm et un fermoir mousqueton ultra-sécurisé pour un porté agréable du matin jusqu\'au soir.\n\n🎁 Un cadeau prêt à offrir (et inoubliable) — le collier est livré dans un somptueux écrin en velours beige fait main, aussi beau à ouvrir qu\'utile pour ranger le bijou au quotidien. Aucun emballage supplémentaire n\'est nécessaire : l\'effet « waouh » est garanti dès l\'ouverture !<br>• Sécurité &amp; Qualité : certifié CE et REACH, sans nickel et hypoallergénique, il prend soin de votre peau en toute sérénité.\n\n👉 Craquez pour un bijou chargé d\'émotion ou faites plaisir à coup sûr pour un anniversaire, une fête ou une déclaration d\'amour.',
    description_en: '✨ The Heart &amp; Birthstone Necklace: elegance that tells your story. More than just a piece of jewelry — a true symbol of love and family.\n\nGive it as a gift, or treat yourself to this customizable necklace in 18k rose gold-tone plating, designed to capture your life\'s most precious moments. At its center, an elegant heart-shaped pendant watches over a cluster of sparkling charms set with diamond-style crystals.\n\n💎 What makes this piece unique:<br>• Your story at a glance: personalize it with up to 12 birthstones to represent your loved ones (family, children, a couple).<br>• Shine and durability: made from high-quality copper with a luxurious 18k rose gold-tone plating, it withstands everyday life while keeping its magical shine.<br>• Total comfort: a delicate 45 cm cross-chain and an ultra-secure lobster clasp for comfortable wear from morning to night.\n\n🎁 A gift that\'s ready to give (and unforgettable) — the necklace comes in a sumptuous handmade beige velvet box, as beautiful to open as it is practical for everyday storage. No extra wrapping needed: the "wow" effect is guaranteed the moment it\'s opened!<br>• Safety &amp; Quality: CE and REACH certified, nickel-free and hypoallergenic, so it\'s gentle on your skin.\n\n👉 Treat yourself to a piece of jewelry filled with emotion, or give a guaranteed-to-please gift for a birthday, celebration, or declaration of love.',
    ecoDetails: 'Cuivre plaqué or rose 18 carats, conforme aux normes REACH (sans substances chimiques nocives). Fabriqué par un fournisseur audité, engagé dans une chaîne d\'approvisionnement traçable.',
    ecoDetails_en: '18k rose gold-plated copper, REACH compliant (free of harmful chemical substances). Made by an audited supplier committed to a traceable supply chain.',
    safety: 'Certifié CE. Sans nickel ajouté, hypoallergénique. Fermoir mousqueton sécurisé sur chaîne croisée, plaquage résistant à l\'eau et aux parfums en usage normal.',
    safety_en: 'CE certified. No added nickel, hypoallergenic. Secure lobster clasp on a cross-chain, water- and perfume-resistant plating under normal use.',
    care: 'Évitez le contact prolongé avec l\'eau, les parfums, cosmétiques et produits chimiques. Rangez le collier à l\'abri de l\'air et de l\'humidité dans sa boîte en velours pour préserver l\'éclat du plaquage.',
    care_en: 'Avoid prolonged contact with water, perfume, cosmetics and chemicals. Store the necklace away from air and moisture in its velvet box to preserve the shine of the plating.',
    sizeGuide: [
      ['Caractéristique', 'Détail'],
      ['Matériau', 'Cuivre plaqué or rose 18 carats'],
      ['Type de chaîne', 'Chaîne croisée'],
      ['Pierre principale', 'Cristal façon diamant (zircon)'],
      ['Type de collier', 'Collier avec pendentif'],
      ['Style', 'Classique'],
      ['Forme du pendentif', 'Cœur, motif géométrique'],
      ['Genre', 'Unisexe'],
      ['Longueur de chaîne', '45 cm'],
      ['Dimensions du pendentif', '15,5 x 17 mm, épaisseur 2,5-5 mm'],
      ['Poids', '≈ 9-10 g'],
      ['Marque', 'Zhongzhe'],
      ['Origine', 'Zhejiang, Chine'],
      ['Certifications', 'CE, REACH'],
      ['Emballage', 'Boîte à bijoux en velours beige, 10 x 5 x 5 cm']
    ],
    sizeGuide_en: [
      ['Feature', 'Detail'],
      ['Material', '18k rose gold-plated copper'],
      ['Chain type', 'Cross-chain'],
      ['Main stone', 'Diamond-style crystal (zircon)'],
      ['Necklace type', 'Pendant necklace'],
      ['Style', 'Classic'],
      ['Pendant shape', 'Heart, geometric pattern'],
      ['Gender', 'Unisex'],
      ['Chain length', '45 cm'],
      ['Pendant dimensions', '15.5 x 17 mm, 2.5-5 mm thick'],
      ['Weight', '≈ 9-10 g'],
      ['Brand', 'Zhongzhe'],
