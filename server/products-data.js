...
const PRODUCTS = [
  ...
  /* ===== BIJOUX & ACCESSOIRES ===== */
  {
    ...
    description: 'Ce collier personnalisable marie l\'élégance intemporelle à une touche unique et symbolique : un pendentif cœur central entouré de charms sertis de cristaux façon diamant, où chaque pierre peut représenter le mois de naissance d\'un être cher — jusqu\'à 12 pierres de naissance au choix, pour créer un bijou qui raconte votre histoire de famille.\n\nFabriqué en cuivre de haute qualité avec un plaquage or rose 18 carats, ce collier allie brillance durable et résistance au quotidien. La chaîne croisée, longue de 45 cm, se ferme grâce à un fermoir mousqueton sécurisé, et le pendentif mesure environ 15,5 x 17 mm pour une épaisseur de 2,5 à 5 mm — un format délicat qui se porte aussi bien au quotidien que lors d\'occasions spéciales (anniversaires, fête des mères, cadeaux de couple).\n\nChaque collier peut être personnalisé avec un logo ou un message gravé en DIY, ce qui en fait un cadeau particulièrement apprécié pour marquer un anniversaire, une naissance, ou simplement pour dire « je t\'aime » à sa manière. Le bijou est unisexe et convient aussi bien pour offrir que pour un usage personnel.\n\nFabriqué par Zhongzhe Jewelry, un fabricant basé à Zhejiang (Chine) avec plus de 13 ans d\'expérience et une note de 4,9/5 sur plus de 4 100 avis vérifiés, ce collier est certifié CE et REACH, garantissant l\'absence de substances nocives et de nickel ajouté.\n\nLe collier est présenté dans un écrin à bijoux en velours beige haut de gamme, entièrement fait main : doux au toucher, refermable grâce à un couvercle à charnière, avec un intérieur qui maintient le collier bien en place et met en valeur le pendentif dès l\'ouverture. Compact (10 x 5 x 5 cm) et déjà prêt à offrir, il fait office d\'écrin de présentation autant que de rangement au quotidien, sans emballage supplémentaire nécessaire.',
    description_en: 'This customizable necklace blends timeless elegance with a unique, symbolic touch: a central heart pendant surrounded by charms set with diamond-style crystals, where each stone can represent the birth month of a loved one — choose up to 12 birthstones to create a piece that tells your own family story.\n\nCrafted from high-quality copper with 18k rose gold-tone plating, this necklace combines lasting shine with everyday durability. The 45 cm cross-chain closes with a secure lobster clasp, and the pendant measures roughly 15.5 x 17 mm at a thickness of 2.5 to 5 mm — a delicate size suited both for daily wear and special occasions (birthdays, Mother\'s Day, couple gifts).\n\nEach necklace can be personalized with a DIY engraved logo or message, making it an especially thoughtful gift to mark a birthday, a birth, or simply to say "I love you" in your own way. The piece is unisex, equally suited as a gift or for personal everyday wear.\n\nMade by Zhongzhe Jewelry, a manufacturer based in Zhejiang, China with over 13 years of experience and a 4.9/5 rating across more than 4,100 verified reviews, this necklace is CE and REACH certified, guaranteeing no added nickel or harmful substances.\n\nThe necklace comes in a premium beige velvet jewelry box, entirely handmade: soft to the touch, closing with a hinged lid, with an interior that holds the necklace securely in place and shows off the pendant the moment it\'s opened. Compact (10 x 5 x 5 cm) and gift-ready as is, it doubles as a display case and everyday storage box, with no extra wrapping needed.',
