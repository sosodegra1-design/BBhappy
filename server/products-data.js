...
const PRODUCTS = [
  ...
  /* ===== BIJOUX & ACCESSOIRES ===== */
  {
    ...
    price: 19.99, oldPrice: null, icon: ICONS.collier, images: ['images/products/bj1-1.jpg', 'images/products/bj1-2.jpg', 'images/products/bj1-3.jpg', 'images/products/bj1-4.jpg'], bg: '#f2ead6',
    ...
    description: 'Collier personnalisable en cuivre plaqué or rose, avec pendentif cœur serti d\'un cristal façon diamant. 12 pierres de naissance au choix (une par mois de naissance) et logo à graver en DIY, pour un bijou unique à offrir ou à porter au quotidien. Livré dans une boîte à bijoux haut de gamme en velours beige, faite main.',
    description_en: 'Customizable copper necklace with rose gold-tone plating, featuring a heart pendant set with a diamond-style crystal. Choose from 12 birthstones (one per birth month) and a DIY engraved logo, for a one-of-a-kind piece to gift or wear every day. Delivered in a premium handmade beige velvet jewelry box.',
